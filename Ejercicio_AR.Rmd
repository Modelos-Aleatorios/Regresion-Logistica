...
```{r}
plot(icu.reduced$AGE, icu.reduced$STA, main = "Estado Vital vs. Edad", xlab = "AGE - Edad",
     ylab = "STA - Estado Vital al ser dado de alta", col=ifelse(icu.reduced$STA==1,"red","blue"))
```
...
Ya tenemos la cantidad de individuos por cada intervalo definido mediante la función `findInterval`.
...
plot(tblFreq, main = "Pacientes en cada Intervalo", 
    xlab="AGE - Edad", ylab = "Media Estado Vital (STA)", type = "l", col= "blue")
```
...
```{r}
plot(mid, deadMean, main = "Punto Medio por Intervalo vs. Media del Estado Vital", 
    xlab="Punto Medio por Intervalo de Edad", ylab = "Media del Estado Vital (STA)", type = "l", col= "blue")
```
