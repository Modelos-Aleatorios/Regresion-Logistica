...
D & =-2ln(\text{verosimilitud con el modelo ajustado})\\
...
l(\beta) & =  ln\left( \left( \frac{n_1}{n} \right)^{\sum_{i=1}^n y_i}\left(\frac{n_0}{n}\right)^{\sum_{i=1}^n 1-y_i}\right)\\
...
\hat \pi(x) & = \frac{e^{\ln(\frac{n_1}{n_0})}}{1+e^{\ln(\frac{n_1}{n_0})}}\\
\hat \pi(x) & = \frac{\frac{n_1}{n_0}}{1+\frac{n_1}{n_0}}\\
\hat \pi(x) & = \frac{\frac{n_1}{n_0}}{\frac{n_0+n_1}{n_0}}\\
...
\begin{array}{rl}
\hat \pi(x) & = \frac{n_1}{n}\\
\hat \pi(x) & = \frac{\sum_{i=1}^n y_i}{n}\\
\hat \pi(x)& = \bar y
\end{array}
$$
